...
module SPFP_Mul_T_tb;
	...
	initial begin 
		$readmemh("C:/Users/Jazoolee/Desktop/Quartus/SPFP_ALU/TestVectorMultiply", testVector);
		mcd = $fopen("C:/Users/Jazoolee/Desktop/Quartus/SPFP_ALU/ResultsMultiplication.txt");
	end 
